...
var StorySadBox = require('../StorySadBox.jsx')
var StorySubmit = require('../StorySubmit')
var Button = require('react-bootstrap').Button
var auth = require('../auth.jsx')

const SadStories = React.createClass({
  getInitialState() {
    return {
  ...
  return (
    ...
    <Row className="show-grid">
      ...
      <Col  md={6}> <StorySadBox url={this.props.url} pollInterval={this.props.pollInterval}/>  </Col>
