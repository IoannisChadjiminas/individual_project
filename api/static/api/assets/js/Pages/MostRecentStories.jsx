...
var StoryTimePublishedBox = require('../StoryTimePublishedBox.jsx')
...
const MostRecentStories = React.createClass({
  getInitialState() {
    return {
  ...
  return (
    ...
    <Row className="show-grid">
      ...
      <Col  md={6}> <StoryTimePublishedBox url={this.props.url} pollInterval={this.props.pollInterval} /> </Col>
...
module.exports = MostRecentStories;